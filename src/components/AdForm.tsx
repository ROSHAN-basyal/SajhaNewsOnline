...
interface AdFormProps {
  ad?: Advertisement
  onSubmit: (adData: Omit<Advertisement, 'id' | 'created_at' | 'updated_at'>) => Promise<{ success: boolean; error?: string }>
  onCancel: () => void
  loading: boolean
...
export default function AdForm({ ad, onSubmit, onCancel, loading, selectedPlacement }: AdFormProps) {
  const [formData, setFormData] = useState({
    title: '',
    description: '',
    image_url: '',
    click_url: '',
    placement: selectedPlacement || 'header',
  ...
  useEffect(() => {
    if (ad) {
      ...
      setFormData(prev => ({ ...prev, placement: selectedPlacement }))
    }
        ...
        <div className="form-grid">
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              ...
              />
              {errors.click_url && <span className="field-error">{errors.click_url}</span>}
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              ...
              {errors.placement && <span className="field-error">{errors.placement}</span>}
            ...
            <div className="form-group">
              ...
              <div className="form-hint">Higher priority ads show first (10 = highest)</div>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              ...
              <input
                type="number"
                className={`form-input ${errors.target_impressions ? 'error' : ''}`}
                value={formData.target_impressions}
                onChange={(e) => handleInputChange('target_impressions', parseInt(e.target.value) || 0)}
                min={0}
                placeholder="0"
              />
              {errors.target_impressions && <span className="field-error">{errors.target_impressions}</span>}
              <div className="form-hint">Set to 0 for unlimited impressions</div>
            </div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) => handleInputChange('target_clicks', parseInt(e.target.value) || 0)}
                min={0}
                placeholder="0"
              />
              {errors.target_clicks && <span className="field-error">{errors.target_clicks}</span>}
